...
DefaultWeapons = ["M9SD","Itemtoolbox","ItemHatchet_DZE","ItemMap","ItemCompass"];
...
call compile preprocessFileLineNumbers "client_redirect\compiles.sqf";				//Compile regular functions
...
execVM "client_redirect\DynamicWeatherEffects.sqf";
